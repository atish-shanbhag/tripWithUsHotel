...
function pricingLowtoHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}

function pricingHightoLow(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    result = hotelCopy.sort(pricingLowtoHigh);
  } else {
    result = hotelCopy.sort(pricingHightoLow);
  }
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'low-to-high') {
    result = hotelCopy.sort(ratingLowtoHigh);
  } else {
    result = hotelCopy.sort(ratingHightoLow);
  }
  res.json({ hotels: result });
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'least-to-most') {
    result = hotelCopy.sort(reviewLeastToMost);
  } else {
    result = hotelCopy.sort(reviewMostToLeast);
  }
  res.json({ hotels: result });
});
